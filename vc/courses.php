	...
	<div class="w3-container">
		<div class="row">
			...
			<div class="col-sm-10 w3-animate-right">
				<div class="row">
					<h3>Courses</h3>
					<button class="w3-btn w3-round w3-orange" onclick="document.getElementById('assign').style.display='block'"><span class="glyphicon glyphicon-tags"></span> assign lecturer</button>
					<button class="w3-btn w3-round w3-green w3-right" onclick="document.getElementById('Course').style.display='block'"><span class="glyphicon glyphicon-plus"></span> add course</button><br>
					<hr>
