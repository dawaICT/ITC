			...
			<div class="col-sm-9 w3-animate-right">
				...
				<div class="w3-card-4">
							...
							if (isset($_POST['submit'])) {
								...
								if (!in_array($selectedSemester, ['1', '2'], true) || !ctype_digit($selectedYear)) {
									...
									$sql = "SELECT e.Sid, e.Course_Code, c.course_name,
											       ...
											       COALESCE(e.Total_marks, e.Exam_marks) AS Total_marks,
											       e.Year, e.semester
											FROM exams e
					...
					<div id="printScript">
								...
								<fieldset class="w3-border">
									...
									<?php
											foreach($records as $r) {
												// Grade/points only once the final exam was sat; otherwise NE.
												$wroteExam = wuc_result_exam_written($r->Total_marks);
										...
										<tr>
												...
												<td class="w3-left">
													<?php echo $wroteExam ? exam_report_h(exam_report_grade($totalGrade)) : WUC_RESULT_NOT_EXAMINED; ?>
													</td>

													<td><?php echo exam_report_h($r->Year ?? ''); ?></td><td class="w3-left">
													<?php echo $wroteExam ? exam_report_h(exam_report_points($totalGrade)) : WUC_RESULT_NOT_EXAMINED; ?>
													</td>
												</tr>
									...
									<h2 class="w3-center"><strong>Lite View College</strong></h2>
									<div class="w3-center"><img src="images/Logo.jpeg" width="120" height="100"></div>
						...
						<button class="w3-btn w3-green w3-center w3-round-large" onClick="printContent('printScript')">
