		...
		<div class="row">
			...
			<div class="col-sm-9 w3-card-4 w3-animate-right">
				<div class="row">
					<h3>Students</h3>
					<hr>
					<a href="reportManager.php"><button class="w3-btn w3-round w3-green w3-right">
					...
					<div class="w3-container">
						<br>
							<?php
								...
								if($results = $db->query("SELECT * FROM students INNER JOIN student_program
							...
							<table id="myTable" class="table table-hover align-middle">
								...
								<tbody>
									...
									?>
										...
										<td class="w3-center">
											<a class='btn w3-green' href="view_student_admin.php?view=<?php echo $r->SID?>"><span class="glyphicon glyphicon-eye-open"></span>
											</a>
