			      ...
			      <div class="w3-container">
					 <form action="process_invoice_1.php" method="post" role="form">
		                <?php
		                    ...
		                    if($Results = $db->query("SELECT student_program.*, program_fees.semester_fee
                            FROM student_program INNER JOIN program_fees
                        ...
                        <input type="hidden" class="form-control" name="program_code" id="program_code" 
                          ...
                          value="<?php echo ($r->semester_fee); ?>" autocomplete="off" readonly>
		                  <label for="balance">Total current balance (ZMW):</label><br>
					  <input type="text" class="form-control" name="balance" id="balance" 
                          value="<?php echo ($r->balance) + ($r->semester_fee); ?>" autocomplete="off" readonly>
