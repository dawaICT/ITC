		...
		<div class="row">
			...
			<div class="col-sm-10 w3-animate-right">
				<div class="row">
					...
					<button class="w3-btn w3-round w3-green w3-right" onclick="document.getElementById('semester').style.display='block'"><span class="glyphicon glyphicon-plus"></span> Add new</button><br>
					<hr>
