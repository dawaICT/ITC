	...
	<div class="w3-container">
		<div class="row">
			...
			<div class="col-sm-10 w3-animate-right">
				<div class="row">
					<h3>News & Events</h3>
					<button class="w3-btn w3-round w3-red"><span class="glyphicon glyphicon-eye-open"></span> applicants</button>
					<button class="w3-btn w3-round w3-orange w3-right"><span class="glyphicon glyphicon-plus"></span> add event</button><br>
					<hr>
