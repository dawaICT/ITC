...
/**
 * Skills-to-Trade Hub — Rejected items (lecturer view).
 */

$page_title = 'Rejected Items — Skills-to-Trade';
require_once __DIR__ . '/../includes/guard.php';
require_once dirname(__DIR__, 2) . '/includes/enterprise_hub/bootstrap.php';

eh_require($db, 'enterprise.review.lecturer');

$items = eh_list_by_status($db, 'rejected', 200);
...
<div class="container-fluid px-4 portal-dashboard">
    <div class="dashboard-header admin-section mb-4">
        <div class="row align-items-center g-3">
            <div class="col">
                <h1 class="dashboard-title"><i class="fas fa-times-circle me-2 text-danger"></i>Rejected Items</h1>
                <p class="text-muted mb-0">Enterprises rejected during lecturer or administrative review.</p>
            </div>
            <div class="col-auto">
    ...
    <section class="data-table-card">
        <div class="card-header">
            <h5 class="mb-0"><i class="fas fa-ban me-2"></i>Rejected (<?php echo count($items); ?>)</h5>
        </div>
        <div class="card-body p-0">
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        <?php if (!$items): ?>
                            <tr><td colspan="6" class="text-center text-muted py-5">No rejected items.</td></tr>
                        <?php else: ?>
                            <?php foreach ($items as $row): ?>
                                <tr>
                                    ...
                                    <td class="small"><?php echo eh_h((string)($row['updated_at'] ?? '')); ?></td>
                                    <td class="text-end">
