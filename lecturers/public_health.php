<?php
$page_title = 'Public Health CA Upload';
...
if (isset($_POST["submit"]) && isset($_FILES["file"])) {
    ...
    if (!$file || !is_uploaded_file($file)) {
        ...
        wuc_safe_redirect('public_health.php');
    }
    ...
    while (($csv = fgetcsv($file_open, 10000, ",")) !== false) {
        ...
        // Public Health scaling: A1,A2 × 0.05, T1,T2 × 0.15
        ...
        $save = ca_save_components($db, $Sid, $Course_Code, $semester, $Year, 'public_health', [
            'A1' => $A1,
            'A2' => $A2,
            'T1' => $T1,
            'T2' => $T2,
    ...
    fclose($file_open);
    wuc_flash('success', "Public Health CA Upload: $success processed, $skipped skipped, $errors errors.");
...
<div class="container-fluid px-4 portal-dashboard">
    <div class="dashboard-header admin-section mb-4">
        <div class="row align-items-center">
            <div class="col">
                <h1 class="dashboard-title">Public Health CA Upload</h1>
                <p class="text-muted">CSV Upload for Public Health programme marks</p>
            </div>
            <div class="col-auto">
    ...
    <div class="card shadow">
        <div class="card-header"><h5 class="mb-0"><i class="fas fa-file-csv me-2"></i>Upload Public Health CA CSV</h5></div>
        <div class="card-body">
            <div class="alert alert-info">
                <i class="fas fa-info-circle me-2"></i>
                <strong>Public Health CA:</strong> Enter A1, A2, T1, and T2 as local CA marks out of 100. External examination marks are not uploaded here.
            </div>
            <form action="public_health.php" method="post" enctype="multipart/form-data">
                <div class="mb-3">
